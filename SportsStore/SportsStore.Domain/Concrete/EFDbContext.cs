...
namespace SportsStore.Domain.Concrete
{
    ...
    public class SportsStoreDbInitializer : DropCreateDatabaseIfModelChanges<EFDbContext>
    {
        protected override void Seed(EFDbContext context)
        {
            ...
            {
                new Product { ProductID = 1, Name = @"Kayak", Description = @"A boat for one person", Price = 275M, Category =  @"Watersports" },
                new Product { ProductID = 2, Name = @"Lifejacket", Description = @"Protective and fashionable", Price = 48.95M, Category =  @"Watersports" },
